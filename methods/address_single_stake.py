...
def saveascsv():
    ...
    data_file = open("../response/csv/singlestake_response.csv", 'w', newline='')
...
def change_data():
    file = pd.read_csv("../response/csv/singlestake_response.csv")
    ...
    df.to_csv("../response/csv/deposits_into_singlestaking_pool.csv", index=False)
